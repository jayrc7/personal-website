...
var tag = { "tags": ["Organization", "Hackathon", "JQuery", "React", "Java", "Python", "HTML/CSS", "Javascript", "Firebase", "Linux", "Twilio", "JavaFX", "PyGTK", "Game"] }
export { proj, tag }
