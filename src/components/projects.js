  ...
  "projects": [
    {
      ...
      "tags": ["Javascript", "React", "API", "Web"]
    },

    {
      "name": "Live Well San Diego Market Evaluation Tool",
      "link": "https://liveweller.herokuapp.com/",
      "description": ["Developed market evaluation tool using HTML/CSS/Javascript/JQuery, configured database to push/pull client responses using Firebase.", "Engineered and tested algorithm that handles market evaluation.", "Implemented dynamic front end using JQuery."],
      "tags": ["Javascript", "HTML/CSS", "JQuery", "API", "Firebase", "Web"]
    },
...

    {
      ...
      "description": ["Created classic game where player must eliminate all bricks by reflecting the ball off of a paddle.", "Created using JavaFX api for frontend and java for backend." ],
      "tags": ["Java", "Game", "API"],
    }
...
var tag = { "tags": ["JQuery", "React", "Java", "Python", "HTML/CSS", "Javascript", "Hackathon", "Firebase", "Linux", "API", "Web", "Game"] }
export { proj, tag }
