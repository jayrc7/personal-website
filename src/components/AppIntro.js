    ...
    render(){
        return(
            <div className = "intro">
                ...
                <p className = "parag"> Here at UCSD I've been able to build on my passion for software development by taking rigorous courses, doing side projects, and by being apart of orgs such as Triton Software Engineering and Triton Robosub. Feel free to contact me if you have any suggestions for side projects or you'd like to hear more about my projects/involvement with my orgs. If you'd also like to talk about the premier league and why Manchester City are too good then I'm your guy. </p>
            </div>
        )
    }
}
