		...
		return (
			...
			<Container inverted text>
				...
				<ExperienceItem title = "Bentley Systems - Incoming Software Engineering Intern" 
					loc = "San Diego, California" date = "Summer 2020" description = "I'm excited to be at Bentley Systems this summer as a Software Engineering Intern! Looking forward to being in a team that develops software for a company that promotes the safety of infrastructure around the world. More details to come." />
				
				<ExperienceItem title="Triton Software Engineering - Project Manager"
					loc="UC San Diego" date="Fall 2019 - Current" description="Leading a team of five members to create a website for a nonprofit dance organization. My main role is to ensure the success of the website in a timely manner while providing a challenging, friendly, and engaging environment for my team. More responsibilities consists of: task management, code reviews, providing assistance with implementation details or software development practices like using Github, facilitating weekly meetings where the team can discuss about the project, reporting to executive board every week about the team's progress." />
